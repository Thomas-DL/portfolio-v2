        ...
        <div
            ...
            <figure data-aos="fade-up" data-aos-delay="200"
                ...
                <blockquote
                    ...
                    <p>“Merci Thomas pour ton excellent travail sur mon site. Tes conseils et ton suivi ont rassuré le
                        néophyte que je suis, et le tutoriel que je garde précieusement me permet d’envisager l’avenir
                        avec sérénité!
                        Je reviendrai bientôt vers toi pour une nouvelle extension du site!”</p>
                </blockquote>
                <figcaption
                    class="flex flex-wrap items-center gap-x-4 gap-y-4 border-t border-gray-900/10 px-6 py-4 sm:flex-nowrap">
                    <div class="flex-auto">
                        <div class="font-semibold">Jérôme Spenlehauer</div>
                        <div class="text-gray-600">@jihesse</div>
                    </div>
                </figcaption>
            </figure>
