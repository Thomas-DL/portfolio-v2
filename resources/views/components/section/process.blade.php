            ...
            <nav aria-label="Progress">
                <ol role="list" class="overflow-hidden">
                    <li data-aos="fade-down" class="relative pb-10">
                        <div class="absolute left-4 top-4 -ml-px mt-0.5 h-full w-0.5 bg-gradient-to-r from-[#FF007A] to-[#FF7A00]"
                            aria-hidden="true">
                        </div>
                        <!-- Complete Step -->
                        <a href="#" class="group relative flex items-start">
                            <span class="flex h-9 items-center">
                                <span
                                    class="relative z-10 flex h-8 w-8 items-center justify-center rounded-full bg-gradient-to-r from-[#FF007A] to-[#FF7A00] group-hover:bg-indigo-800">
                            ...
                            <span class="ml-4 flex min-w-0 flex-col">
                                <span
                                    class="text-sm font-medium bg-gradient-to-r from-[#FF007A] to-[#FF7A00] text-transparent bg-clip-text">Create
                                    account</span>
                                <span class="text-sm text-gray-500">Vitae sed mi luctus laoreet.</span>
                            </span>
                        </a>
                    </li>
                    <li data-aos="fade-down" data-aos-delay="150" class="relative pb-10">
                        <div class="absolute left-4 top-4 -ml-px mt-0.5 h-full w-0.5 bg-gradient-to-r from-[#FF007A] to-[#FF7A00]"
                            aria-hidden="true">
                        </div>
                        <!-- Complete Step -->
                    ...
                    <li data-aos="fade-down" data-aos-delay="300" class="relative pb-10">
                        <div class="absolute left-4 top-4 -ml-px mt-0.5 h-full w-0.5 bg-gradient-to-r from-[#FF007A] to-[#FF7A00]"
                            aria-hidden="true">
                        </div>
                        <!-- Complete Step -->
                    ...
                    <li data-aos="fade-down" data-aos-delay="450" class="relative pb-10">
                        <div class="absolute left-4 top-4 -ml-px mt-0.5 h-full w-0.5 bg-gradient-to-r from-[#FF007A] to-[#FF7A00]"
                            aria-hidden="true">
                        </div>
                        <!-- Complete Step -->
                    ...
                    <li data-aos="fade-down" data-aos-delay="600" class="relative">
                        <a href="#" class="group relative flex items-start">
                            <span class="flex h-9 items-center">
                                <span
                                    class="relative z-10 flex h-8 w-8 items-center justify-center rounded-full bg-gradient-to-r from-[#FF007A] to-[#FF7A00] group-hover:bg-indigo-800">
