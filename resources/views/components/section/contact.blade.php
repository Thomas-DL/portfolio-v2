<section class="relative isolate bg-gray-950">
            ...
            <div class="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
                <div class="absolute inset-y-0 left-0 -z-10 w-full overflow-hidden ring-1 ring-white/5 lg:w-1/2">
                    ...
                    <div class="absolute -left-56 top-[calc(100%-13rem)] transform-gpu blur-3xl lg:left-[max(-14rem,calc(100%-59rem))] lg:top-[calc(50%-7rem)]"
                        aria-hidden="true">
                        <div class="aspect-[1155/678] w-[72.1875rem] bg-gradient-to-br from-[#FF007A] to-[#FF7A00] opacity-20"
                ...
                <p class="mt-6 text-lg leading-8 text-gray-300">Proin volutpat consequat porttitor cras nullam gravida
