...
<section id="services" class="isolate overflow-hidden">
    <div class="relative flow-root bg-gray-950 pb-16 pt-24 sm:pt-32 lg:pb-0">
        <div class="mx-auto max-w-7xl mb-24 px-6 lg:px-8">
            <div class="relative z-10 text-center">
                ...
                <p data-aos="fade-up" data-aos-delay="200"
                    class="mx-auto mt-4 max-w-2xl text-center text-lg leading-8 text-white">
            ...
            <div
                ...
                <div data-aos="fade-right" data-aos-delay="300"
                    ...
                    <div class="p-8 lg:pt-12 xl:p-10 xl:pt-14">
                        <h3 id="tier-starter" class="text-sm font-semibold leading-6 text-white">
                            {{ $landing['headline'] }}</h3>
                        <div
                            class="flex flex-col gap-6 sm:flex-row sm:items-end sm:justify-between lg:flex-col lg:items-stretch">
                            <div class="mt-2 flex items-center gap-x-4">
                                <!-- Price, update based on frequency toggle state -->
                                <p class="text-4xl font-bold tracking-tight text-white">{{ $landing['name'] }}</p>
                            </div>
                            <a href="#" aria-describedby="tier-starter"
                                class="rounded-full py-2 px-3 text-center text-sm font-semibold leading-6 text-white hover:scale-105 transition ease-in-out focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 bg-white/10 hover:bg-white/20 focus-visible:outline-white">
                                PRENDRE RDV
                            </a>
                        </div>
                ...
                <div data-aos="fade-up" data-aos-delay="200"
                    ...
                    <div class="p-8 lg:pt-12 xl:p-10 xl:pt-14">
                        ...
                        <div
                            ...
                            <div class="mt-2 flex items-center gap-x-4">
                                <!-- Price, update based on frequency toggle state -->
                                <p class="text-4xl font-bold tracking-tight text-gray-900">{{ $premium['name'] }}</p>
                            </div>
                            <a href="#" aria-describedby="tier-scale"
                                class="rounded-full py-2 px-3 text-center text-sm font-semibold leading-6 text-white hover:scale-105 transition ease-in-out focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 bg-gradient-to-r from-primary to-secondary shadow-sm">
                                PRENDRE RDV
                            </a>
                        </div>
                        <div class="mt-8 flow-root sm:mt-10">
                ...
                <div data-aos="fade-left" data-aos-delay="300"
                    class="relative rounded-2xl bg-gray-800/80 ring-1 ring-white/10 lg:bg-transparent lg:pb-14 lg:ring-0">
                    <div class="p-8 lg:pt-12 xl:p-10 xl:pt-14">
                        <h3 id="tier-growth" class="text-sm font-semibold leading-6 text-white">
                            {{ $website['headline'] }}
                        </h3>
                        <div
                            class="flex flex-col gap-6 sm:flex-row sm:items-end sm:justify-between lg:flex-col lg:items-stretch">
                            <div class="mt-2 flex items-center gap-x-4">
                                <!-- Price, update based on frequency toggle state -->
                                <p class="text-4xl font-bold tracking-tight text-white">{{ $website['name'] }}</p>
                            </div>
        ...
        <div class="absolute inset-x-0 bottom-0 z-[1] h-24 bg-gradient-to-t from-gray-950 sm:h-32"></div>
    </div>
